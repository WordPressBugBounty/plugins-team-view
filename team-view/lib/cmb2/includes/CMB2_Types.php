...
?>
		...
		<p class="cmb-add-row">
			<button type="button" data-selector="<?php echo esc_attr($table_id); ?>" class="cmb-add-row-button button"><?php echo esc_html($this->_text('add_row_text', esc_html__('Add Row', 'team-view'))); ?></button>
		</p>
	...
	?>
		...
		<div class="cmb-row <?php echo esc_attr($class); ?>">
			...
			<div class="cmb-td cmb-remove-row">
				<button type="button" class="button cmb-remove-row-button<?php echo esc_attr($disabled); ?>"><?php echo esc_html($this->_text('remove_row_text', esc_html__('Remove', 'team-view'))); ?></button>
			</div>
		</div>
